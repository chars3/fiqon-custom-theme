...
function render_app_trigger_metabox($post) {
    ...
    <style>
        #app-trigger-container { display: flex; flex-direction: column; gap: 10px; }
        .app-trigger { display: flex; align-items: center; gap: 10px; background: #f9f9f9; padding: 10px; border-radius: 8px; transition: opacity 0.2s ease-in-out; }
        .trigger-title, .trigger-desc { padding: 8px; border: 1px solid #ccc; border-radius: 5px; font-size: 14px; }
        .trigger-title { flex: 1; min-width: 150px; }
        .trigger-desc { flex: 2; min-height: 40px; resize: vertical; }
        .remove-trigger { background: #ff4d4d; color: white; border: none; border-radius: 50%; width: 30px; height: 30px; font-size: 16px; cursor: pointer; transition: background 0.2s; }
        .remove-trigger:hover { background: #cc0000; }
        #add-trigger { background: #0073e6; color: white; border: none; padding: 8px 12px; border-radius: 5px; font-size: 14px; cursor: pointer; margin-top: 10px; }
        #add-trigger:hover { background: #005bb5; }
    </style>
    <?php
}
